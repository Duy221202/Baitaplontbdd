...
function Screen2({}){
    ...
    return(
        <View style={{ flex:1 , justifyContent: 'center',backgroundColor:'black' }}>
            <View style={{flexDirection:"row", justifyContent:"space-between", width:"100%", marginLeft:"0px"}}>
                <Image source={require("./IMG/2_1call11.png")} style={{height:"35px",width:"35px",marginLeft:"5px"}}/>
